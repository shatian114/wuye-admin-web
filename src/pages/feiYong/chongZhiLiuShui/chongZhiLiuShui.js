...
@Form.create()
class chongZhiLiuShui extends PureComponent {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      searching: false,
      tableColumns: [
        { title: '支付时间', dataIndex: 'zfsj' },
        { title: '支付金额', dataIndex: 'zfje' },
        ...
        { title: '支付订单号', dataIndex: 'seq' },
        { title: '支付方式', dataIndex: 'zffs' },
      ],
      tableDataSource: [],
    };
  }
  ...
  search = e => {
    ...
    console.log('chongZhiLiuShui searchParams', fields.search_rqjg);
    axios
...
export default chongZhiLiuShui;
